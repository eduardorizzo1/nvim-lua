...
_G.packer_plugins = {
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/onedark.vim",
