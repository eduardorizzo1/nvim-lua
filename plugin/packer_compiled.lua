...
_G.packer_plugins = {
  ...
  ["rainbow-delimiters.nvim"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/rainbow-delimiters.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/typescript.nvim",
